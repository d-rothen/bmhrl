...
python -m debugpy --wait-for-client --listen 5999 main.py --procedure train_rl_cap --rl_pretrained_model_dir /home/rothenda/BMT/results/logs/0513/0512140216/checkpoints/E_37 --rl_warmstart_epochs 0 --rl_train_worker True --B 16 --video_features_path /nas/student/DanielRothenpieler/BMT/data/i3d_25fps_stack64step64_2stream_npy/ --audio_features_path /nas/student/DanielRothenpieler/BMT/data/vggish_npy/
