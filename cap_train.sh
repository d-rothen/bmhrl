...
python main.py > /home/rothenda/BMT/slurm_out/print.out --procedure train_rl_cap --mode eval --rl_warmstart_epochs 2 --rl_pretrained_model_dir /home/rothenda/BMT/log/train_rl_cap/baseline/checkpoints/E_3 --rl_train_worker True --B 16 --video_features_path /nas/student/DanielRothenpieler/BMT/data/i3d_25fps_stack64step64_2stream_npy/ --audio_features_path /nas/student/DanielRothenpieler/BMT/data/vggish_npy/